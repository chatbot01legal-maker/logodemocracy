...
const SOPHIA_LOADING_FACTS = [
  ...
  "¿Sabías que? El Índice de Robustez Deliberativa (IRD) parte de 100 puntos y se descuenta por cada salto lógico o área de revisión detectada — nunca se suma por opinión.",
  ...
  "¿Sabías que? Cada observación que hace SOPHIA cita el fragmento exacto de tu texto que la originó — nada queda sin evidencia mostrable.",
  ...
  "¿Sabías que? La ambigüedad léxica (usar palabras que admiten muchas interpretaciones, como 'bueno' o 'justo' sin definirlas) es una de las observaciones más comunes que detecta SOPHIA.",
      ...
      try {
        return `
          <div class="view">
            ...
            <h1 class="view-title">Mapa del Razonamiento <span style="font-size:.6rem; font-weight:600; color:#eab308; border:1px solid #eab308; border-radius:4px; padding:2px 6px; vertical-align:middle; margin-left:8px;">BETA</span></h1>
            <div class="view-body">
              <p>SOPHIA te ayuda a examinar la trayectoria de tus argumentos antes de publicarlos o defenderlos: dónde falta evidencia, dónde la lógica se quiebra, dónde una idea todavía no está madura. Pegá un texto o subí un documento y vas a ver, capa por capa, cómo calibrar tu razonamiento.</p>
  ...
  inicio: {
    ...
    render: () => {
      try {
        return `
          <div class="view">
            <div class="view-eyebrow">Mira cómo estás pensando · v${getSophiaVersion()}</div>
            <h1 class="view-title">SOPHIA como espejo del razonamiento</h1>
            <div class="view-body">
              <p>SOPHIA es una herramienta de inteligencia artificial diseñada para ayudarte a <strong>examinar tu propio razonamiento</strong>.</p>
              <p>No pretende decirte qué pensar ni decidir si tienes razón. Su propósito es hacer visible aquello que normalmente permanece oculto cuando razonamos: nuestras premisas, evidencias, inferencias, supuestos, niveles de confianza y posibles errores.</p>
              <p>SOPHIA reconstruye tu razonamiento y te permite recorrerlo paso a paso. Puedes ver qué detectó, qué evidencia utilizó, qué fue comprobado, qué permanece incierto y dónde podría incluso haberse equivocado el propio instrumento.</p>
              <p>Porque pensar críticamente no consiste solamente en encontrar errores en las ideas de los demás. También consiste en aprender a examinar las propias.</p>
              <p style="font-size:1.1rem; color:var(--accent); font-weight:500; margin-top:15px;">SOPHIA no piensa por ti. Te ayuda a mirar cómo estás pensando.</p>
            </div>
            
            <div class="view-section">
              <div class="view-section-title">Un instrumento abierto y auditable</div>
              <p style="font-size:.85rem; color:rgba(229,231,235,.8); margin-bottom:14px; line-height:1.6;">
                SOPHIA no es una caja negra. Sus criterios, definiciones, mecanismos de evaluación y límites están documentados y pueden ser examinados, discutidos y modificados. Incluso sus propias evaluaciones pueden ser cuestionadas. <strong>No tienes que creerle a SOPHIA. Puedes examinar cómo llegó a lo que te está mostrando.</strong>
              </p>
            </div>

            <div class="view-section">
              <div class="view-section-title">La arquitectura del pensamiento</div>
              <p style="font-size:.82rem; color:rgba(229,231,235,.65); margin-bottom:14px; line-height:1.5;">
                La evaluación técnica que realiza SOPHIA tiene una función pedagógica. Cada capa del sistema está diseñada para que puedas comprender mejor tu trayectoria cognitiva:
              </p>
              <div class="card-grid">
                <div class="s-card">
                  <div class="s-card-title">Sophia Engine (Capa 1)</div>
                  <div class="s-card-body">Estructura el razonamiento. Identifica saltos lógicos, supuestos y evalúa la consistencia interna a través de un protocolo determinista y transparente.</div>
                </div>
                <div class="s-card">
                  <div class="s-card-title">Verificación Factual (Capa 2)</div>
                  <div class="s-card-body">Separa las afirmaciones comprobables de las interpretaciones, mapeando el anclaje empírico de tus argumentos.</div>
                </div>
                <div class="s-card">
                  <div class="s-card-title">Semantic Review (Capa 3)</div>
                  <div class="s-card-body">Cuestiona las señales producidas por el propio instrumento revisando el contexto para evitar falsos positivos y malentendidos literales.</div>
                </div>
                <div class="s-card">
                  <div class="s-card-title">Gemini Review (Capa 4)</div>
                  <div class="s-card-body">Contextualiza, interpreta y genera preguntas reflexivas sobre el camino que lleva desde tus premisas hasta tus conclusiones.</div>
                </div>
              </div>
            </div>

            <div class="view-section">
              <div class="view-section-title">El mapa de tu razonamiento (Capa 1)</div>
              <p style="font-size:.82rem; color:rgba(229,231,235,.65); margin-bottom:14px; line-height:1.5;">
                En su primera capa, SOPHIA genera una radiografía argumentativa estructurada en 5 fases. No te entrega un veredicto definitivo, sino un <strong>mapa de fortalezas y puntos de revisión</strong> para que la autoridad cognitiva vuelva a ti.
              </p>
              <div class="card-grid">
          ...
          <div class="view">
            ...
            <div class="view-section">
              ...
              <div class="flow-steps">
                ...
                <div class="flow-step"><div class="flow-dot">8</div><div class="flow-body"><div class="flow-title">Salida obligatoria</div><div class="flow-desc">Mapa del razonamiento con puntaje, átomos activados y evidencias.</div></div></div>
              </div>
            </div>
        ...
        return `
          <div class="view">
            ...
            <div class="view-body">
              ...
              <p>El resultado es un <strong>mapa del razonamiento</strong> con el desglose por fase, los puntos de revisión detectados y las evidencias textuales.</p>
            </div>
            <div class="eval-tool">
  ...
  _renderEvaluation(data, out) {
    try {
      ...
      out.innerHTML = `
        ...
        ` : `
          <div class="view-section">
            <p style="color:#22c55e;">✅ No se detectaron saltos lógicos ni puntos que requieran revisión.</p>
          </div>
        `}
            ...
            <div style="background:var(--s-panel); border:1px solid var(--s-border); padding:14px;">
              ${data.gemini_review.interpretacion ? `
                <div style="margin-bottom:12px;">
                  <div style="font-size:.75rem; color:var(--accent); text-transform:uppercase; margin-bottom:6px;">Interpretación</div>
                  <div style="font-size:.82rem; color:#e5e7eb; line-height:1.5;">${data.gemini_review.interpretacion}</div>
                </div>` : ''}
            </div>
          </div>
        ` : ''}
