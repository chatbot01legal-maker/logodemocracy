...
En muchos fenómenos complejos, una acción produce una consecuencia que modifica posteriormente las condiciones que dieron origen a la acción.

Esto genera ciclos de retroalimentación.

Comprender estos ciclos permite reconocer que, en un sistema, una causa puede convertirse posteriormente en consecuencia y una consecuencia puede transformarse en una nueva causa.
...
Pero se vuelve insuficiente cuando estudiamos sistemas complejos.

En ellos, las consecuencias pueden regresar al sistema y modificar sus condiciones iniciales.
...
El micrófono capta un sonido.

El parlante lo amplifica.

El micrófono vuelve a captar el sonido amplificado.

El parlante vuelve a amplificarlo.

El proceso puede repetirse hasta producir un fuerte chillido.
...
En teoría de sistemas, sin embargo, significa algo más amplio:

la información producida por un sistema vuelve a influir sobre el propio sistema.

Puede producir diferentes efectos.

Una retroalimentación puede amplificar un proceso.

O puede reducirlo y estabilizarlo.

Por eso es útil distinguir entre dos formas generales.
...
Este tipo de dinámica aparece en fenómenos como:

- efectos de red;
- crecimiento poblacional;
- difusión de información;
- ciertas dinámicas económicas;
- propagación de rumores.

La característica fundamental es que el efecto vuelve al sistema reforzando la dirección inicial.
...
La consecuencia de una modificación puede reducir esa misma modificación.

Un ejemplo cotidiano es un termostato.

Si la temperatura disminuye demasiado, el sistema activa la calefacción.

Cuando la temperatura aumenta hasta determinado nivel, la calefacción se apaga.
...
La retroalimentación, en este caso, contribuye a la estabilidad.
...
Ese temor puede hacer que evite participar en conversaciones.

Las demás personas pueden interpretar su silencio como falta de interés.

Como consecuencia, pueden incluirla menos en las conversaciones.

La persona recibe menos interacción y confirma su impresión inicial de que los demás no quieren relacionarse con ella.
...
Los demás reciben una intervención menos clara y prestan menos atención.

La persona interpreta esa reacción como confirmación de su creencia inicial.

La expectativa ayudó a producir las condiciones que parecían demostrarla.

Esto no significa que todas las creencias se conviertan en realidad.

Significa que algunas creencias pueden formar parte de ciclos causales que influyen sobre los resultados que posteriormente observamos.
...
Un problema puede mantenerse porque diferentes factores se refuerzan mutuamente.
...
Pensar sistémicamente implica buscar también los ciclos.
...
Eso es fundamental para el aprendizaje.

Una persona intenta resolver un problema.
...
Los ciudadanos toman decisiones.

Las instituciones producen resultados.

Los resultados generan información.

La ciudadanía observa esos resultados.

Esa información puede modificar sus preferencias y decisiones futuras.
...
Que dos variables estén relacionadas circularmente no demuestra por sí mismo que exista un mecanismo causal.

Para establecer relaciones causales necesitamos evidencia, mecanismos plausibles y un análisis cuidadoso de las variables involucradas.

La retroalimentación es una herramienta para formular mejores modelos.

No es una explicación automática de cualquier fenómeno.
