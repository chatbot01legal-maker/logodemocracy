...
Acciones
Abre index.html.
Agrega el contenido de tu proyecto.
Conecta style.css.
Conecta script.js.
...
Conecta tu proyecto local con ese repositorio.
Realiza el primer push.
Comprueba que los archivos aparecen en GitHub.
Haz una modificación local.
Guarda el cambio con Git.
Vuelve a subirlo.
Comprueba que GitHub refleja la nueva versión.
Prompt de aprendizaje
...
Internet
Acciones
Crea o abre una cuenta en Render.
Conecta GitHub.
Selecciona el repositorio.
Configura el servicio necesario.
Realiza el primer despliegue.
Espera la construcción.
Abre la URL proporcionada por Render.
Comprueba que tu sitio funciona desde Internet.
...
Acciones
Decide una nueva funcionalidad.
Explícala en lenguaje natural.
Pide a la IA que transforme tu idea en una especificación.
Pide que identifique los archivos que será necesario modificar.
Pide instrucciones técnicas.
Implementa los cambios.
Prueba la funcionalidad.
Lee los errores.
Corrige.
Guarda una nueva versión con Git.
Súbela a GitHub.
...
comprueba las funcionalidades principales;
revisa los errores;
verifica que no existan credenciales expuestas;
guarda una versión estable con Git;
sube la versión a GitHub;
despliega nuevamente en Render;
abre la URL pública;
prueba la aplicación desde otro dispositivo;
comparte el resultado con otra persona.
