...
Su función es ayudar a comprender qué hay realmente detrás de dos posiciones diferentes.

En lugar de determinar quién tiene razón, LOGOS reconstruye los argumentos de cada lado, permite comprobar si fueron comprendidos correctamente, identifica acuerdos, desacuerdos y supuestos compartidos, y examina la naturaleza de las diferencias.

También puede encontrar puntos de convergencia y explorar nuevas posibilidades que no aparecen cuando cada posición se defiende por separado.
...
Dos personas pueden utilizar las mismas palabras para referirse a cosas diferentes.

También pueden compartir determinados objetivos y discrepar solamente respecto de cómo alcanzarlos.

Pueden estar de acuerdo sobre los hechos, pero interpretar de manera diferente sus consecuencias.

O pueden discutir sobre los hechos cuando, en realidad, mantienen una diferencia de valores.

Cuando esto ocurre, el desacuerdo puede parecer mayor de lo que realmente es.

LOGOS intenta hacer visible esta estructura.
...
Tampoco asigna un ganador.

Su función es diferente.

Una posición puede ser considerada correcta por una persona y equivocada por otra. LOGOS puede ayudar a ambas a comprender con mayor precisión qué están defendiendo y por qué.

Por eso, sus resultados describen propiedades del proceso deliberativo y no veredictos sobre las personas o sus posiciones.

LOGOS puede mostrar:

- qué sostiene cada posición;
- qué puntos comparten;
- dónde se separan;
- qué supuestos utilizan;
- qué tipo de desacuerdo existe;
- dónde podrían existir convergencias;
- qué preguntas permanecen abiertas;
- qué nuevas posibilidades podrían explorarse.

La decisión sobre qué posición aceptar continúa perteneciendo a las personas.
...
La prioridad pasa a ser demostrar que la propia posición es correcta.

Esto puede producir una situación paradójica:

las personas pueden discutir durante mucho tiempo sin haber comprendido realmente qué está diciendo la otra.

LOGOS introduce una lógica diferente.

Primero intenta reconstruir.

Después permite verificar la comprensión.

Luego identifica relaciones entre las posiciones.

Finalmente puede explorar posibilidades que surgen de ponerlas en relación.
...
Este paso puede revelar algo importante:

dos posiciones aparentemente opuestas pueden compartir una parte considerable de sus premisas.

El desacuerdo puede estar concentrado solamente en uno o dos puntos.

Hacer visible esa estructura puede cambiar completamente la conversación.
...
Puede existir una convergencia que las propias posiciones ya contienen.

También puede existir una convergencia que solamente aparece bajo determinada condición.
...
Son posibilidades que pueden ser examinadas por las personas.
...
Pero síntesis no significa necesariamente encontrar un punto medio.
...
También intenta determinar qué tipo de diferencia es.
...
Sus indicadores describen propiedades del proceso deliberativo.
...
Una persona puede tener un argumento cuidadosamente construido y, sin embargo, mantener un desacuerdo profundo con otra persona que también presenta un argumento cuidadosamente construido.

En ese caso no basta con evaluar cada posición por separado.

Es necesario comprender la relación entre ambas.

Ahí comienza la función de LOGOS.
...
- dónde discrepan;
- qué tipo de desacuerdo existe;
- qué posibilidades de convergencia aparecen.

El Rey Filósofo puede ayudar a una persona a comprender ese mapa, formular nuevas preguntas y reflexionar sobre su propia posición.
...
Dos personas pueden terminar el proceso comprendiendo perfectamente la posición de la otra y continuar discrepando.

Eso no significa que el proceso haya fracasado.

Por el contrario, puede representar un resultado deliberativo valioso.
...
Cuando las posiciones se observan por separado, cada una puede parecer completa.

Pero cuando se colocan juntas pueden revelar:

- una premisa compartida;
- una contradicción;
- una condición que ninguna había considerado;
- una pregunta mal formulada;
- una posibilidad de cooperación;
- una solución nueva.

Por eso LOGOS no termina necesariamente cuando identifica quién está de acuerdo y quién no.
...
Muchas opiniones pueden producir ruido.

El pensamiento colectivo requiere mecanismos que permitan comprender, comparar, relacionar y transformar esas posiciones.

LOGOS aporta una infraestructura para ese proceso.
...
Es un mapa que permite a las personas deliberar con mayor información sobre la estructura de su propio desacuerdo.
...
- descubrir supuestos compartidos;
- formular mejores preguntas;
- explorar posibilidades de cooperación;
- generar nuevas alternativas.

La inteligencia artificial proporciona infraestructura.

Las personas mantienen la deliberación.

Y las decisiones continúan correspondiendo a quienes participan en ellas.
...
- ¿Estamos discutiendo sobre los mismos hechos?
- ¿Estamos usando los mismos conceptos?
- ¿Compartimos el mismo objetivo?
- ¿Tenemos valores diferentes?
- ¿Estamos de acuerdo sobre el problema pero no sobre la solución?
- ¿Existe una condición bajo la cual nuestras posiciones podrían converger?
- ¿Estamos haciendo la pregunta correcta?

Estas preguntas constituyen el núcleo del pensamiento colectivo.
...
Su función es transformar el desacuerdo en un objeto que pueda ser comprendido, examinado y explorado.
...
Clasifica la naturaleza de los desacuerdos.
...
hacer posible que las personas comprendan mejor aquello que las separa.

Porque cuando el desacuerdo se vuelve visible, también pueden aparecer las cosas que estaban ocultas detrás de él:
...
y las posibilidades que ninguna de las dos posiciones podía ver por sí sola.
