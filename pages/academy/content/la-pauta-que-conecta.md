...
También debemos aprender a observar las relaciones que existen entre ellas.
...
Podemos intentar explicar el problema buscando una causa dentro de la persona:
...
Estamos observando una red de relaciones.

El fenómeno empieza a adquirir otra forma.
...
Es una regularidad en las relaciones.
...
Pero podemos encontrar formas de organización que se parecen.

La capacidad de reconocer esas semejanzas permite trasladar conocimientos de un campo a otro.
...
El problema aparece cuando suponemos que comprender cada parte por separado equivale a comprender el sistema completo.

Un automóvil puede desarmarse y estudiarse pieza por pieza.

Pero conocer cada pieza no explica necesariamente cómo funciona el automóvil cuando todas están conectadas.

Lo mismo ocurre con muchos fenómenos humanos.

Una sociedad no es simplemente la suma de sus individuos.

Una organización no es simplemente la suma de sus trabajadores.

Una conversación no es simplemente la suma de sus frases.

Una economía no es simplemente la suma de sus compradores y vendedores.

En muchos sistemas, las relaciones entre los elementos producen propiedades que no encontramos en los elementos considerados aisladamente.
...
Una determinada forma de relación puede aparecer en dominios completamente distintos.

Por ejemplo, pensemos en la retroalimentación.
...
Una empresa puede modificar su producción observando las ventas.

Una persona puede modificar su conducta observando la reacción de los demás.
...
La complementan con una mirada más amplia.
...
Ese es un riesgo importante.

Que dos fenómenos se parezcan no significa que tengan la misma causa.

Que dos acontecimientos estén relacionados no demuestra que uno haya causado al otro.

Por eso, reconocer pautas debe ir acompañado de evidencia, comparación y pensamiento crítico.

La pregunta de Bateson no nos invita a ver conexiones en todas partes.

Nos invita a aprender a buscar las conexiones relevantes.

Y luego preguntarnos si esas conexiones están realmente respaldadas por la evidencia.
...
Puede ayudarnos a comprender una familia, una organización, una economía, un ecosistema, una conversación, una institución o una sociedad.
