...
Toda representación de la realidad —un concepto, una estadística, una teoría, una fotografía, un modelo, una clasificación o un relato— selecciona determinados aspectos de aquello que representa y deja otros fuera.

Comprender esta diferencia es fundamental para pensar críticamente.

No tenemos acceso directo a la totalidad del mundo. Construimos mapas que nos permiten orientarnos dentro de él.

El problema aparece cuando olvidamos que son mapas.
...
Lo mismo ocurre con nuestras representaciones mentales.
...
En todos estos casos existe una diferencia entre lo representado y la representación.
...
Un mapa de carreteras necesita mostrar caminos y distancias, pero puede ignorar la vegetación.

Un mapa climático muestra temperaturas y precipitaciones, pero no necesariamente las fronteras políticas.

Un mapa político muestra fronteras, pero no representa la experiencia cotidiana de quienes viven dentro de ellas.

La selección no es un defecto accidental.

Es precisamente lo que permite que un mapa sea útil.

Un mapa que intentara contener absolutamente todos los detalles del territorio sería tan complejo como el territorio mismo y perdería su función.
...
Un modelo económico puede simplificar el comportamiento humano.

Un modelo estadístico puede representar relaciones entre variables.

Un modelo psicológico puede describir determinados procesos mentales.

Un modelo climático puede proyectar escenarios futuros.

Que un modelo sea una simplificación no significa que sea inútil.

Significa que debemos conocer para qué fue construido y cuáles son sus límites.

Un modelo puede ser extraordinariamente útil para una pregunta y completamente inadecuado para otra.
...
Son instrumentos intelectuales.

Cuando olvidamos esto, podemos comenzar a defender el mapa en lugar de estudiar el territorio.
...
Una ciudad puede ser representada mediante:

- un mapa de calles;
- un mapa del transporte público;
- un mapa geológico;
- un mapa de densidad poblacional;
- un mapa de ingresos;
- un mapa histórico.

Ninguno es «el verdadero mapa» de la ciudad.

Cada uno responde a una pregunta diferente.

Esto también ocurre con las ideas.

Un fenómeno social puede necesitar simultáneamente una explicación:
...
No necesariamente debemos elegir un único mapa.

A veces necesitamos varios mapas superpuestos.
...
Algunos mapas representan mejor determinados aspectos del territorio que otros.

Una representación puede ser más precisa, estar mejor respaldada por evidencia o resultar más útil para una determinada finalidad.
...
utilizar modelos con confianza cuando están bien justificados y mantener humildad frente a sus límites.
...
Gráficos, estadísticas, titulares, encuestas, categorías políticas, modelos económicos, imágenes y discursos son mapas de diferentes tipos.
...
No toda representación funciona como un mapa geográfico, y no toda simplificación es necesariamente un problema.

La utilidad de una representación depende de su propósito.

Por eso, reconocer que «el mapa no es el territorio» no significa desconfiar automáticamente de los modelos.

Significa aprender a utilizarlos conscientemente.
