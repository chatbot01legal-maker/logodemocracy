document.addEventListener("DOMContentLoaded", () => {
  ...
  // Mantiene en memoria el Activo Cognitivo de forma privada en el módulo
  let currentCognitiveAsset = null;
  ...
  async function loadDocument(name) {
    ...
    try {  
      ...
      // 3. Estructurar y guardar el Activo Cognitivo tipado y versionado
  ...
  /* =========================
     EXPOSICIÓN DE API PUBLICA DE ACADEMIA
  ========================= */
